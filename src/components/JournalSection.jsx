      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="text-4xl font-heading font-bold uppercase tracking-tight md:text-6xl">
              Notes from <br />
              <span className="text-white/38">the Atelier</span>
            </h2>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <motion.article
            ...
            className="group relative min-h-[560px] overflow-hidden rounded-lg border border-white/10 bg-surface"
          >
            <img
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 md:p-10">
              <div className="mb-5 flex flex-wrap items-center gap-3 text-[11px] font-bold uppercase tracking-[0.26em] text-white/50">
                <span>{featurePost.label}</span>
                <span className="h-1 w-1 rounded-full bg-white/35" />
                <span>{featurePost.readTime}</span>
              </div>
              <h3 className="max-w-2xl text-4xl font-heading font-bold leading-none md:text-6xl">
                {featurePost.title}
              </h3>
              <p className="mt-5 max-w-xl text-sm leading-7 text-white/62">
                {featurePost.excerpt}
              </p>
              <button className="mt-8 inline-flex items-center gap-3 rounded-full border border-white/15 px-6 py-3 text-xs font-bold uppercase tracking-[0.24em] text-white transition hover:border-white hover:bg-white hover:text-black">
          ...
          <div className="grid gap-6">
            {supportingPosts.map((post, index) => (
              <motion.article
                ...
                className="group grid min-h-[260px] grid-cols-[0.8fr_1fr] overflow-hidden rounded-lg border border-white/10 bg-white/[0.03] transition hover:border-white/25"
              >
                ...
                <div className="flex flex-col justify-between p-5 md:p-7">
                  <div>
                    <div className="mb-4 flex flex-wrap items-center gap-3 text-[10px] font-bold uppercase tracking-[0.24em] text-white/42">
                  ...
                  <button className="mt-6 flex items-center gap-2 text-left text-xs font-bold uppercase tracking-[0.22em] text-white/65 transition group-hover:text-white">
